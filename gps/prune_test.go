	...
	}{
		{
			...
			co: CascadingPruneOptions{
				...
				PerProjectOptions: map[ProjectRoot]PruneOptionSet{
					ProjectRoot("github.com/integration-system/dep"): {},
				},
			},
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/integration-system/dep"): PruneNestedVendorDirs,
			},
		},
		{
			name: "all overridden",
			...
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/integration-system/dep"): PruneUnusedPackages | PruneNonGoFiles | PruneGoTestFiles,
			},
		},
		{
			name: "all redundant",
