...
Acronym for "Go packaging solver", it is [a subtree of library-style packages within dep](https://godoc.org/github.com/integration-system/dep/gps), and is the engine around which dep is built. Most commonly referred to as "gps."
