...
_Note: there was [a significant omission](https://github.com/integration-system/dep/issues/1561) in v0.4.0's new pruning behavior, so we immediately shipped [v0.4.1](https://github.com/integration-system/dep/releases/tag/v0.4.1) with a fix._
...
Additional information is available in [the release notes](https://github.com/integration-system/dep/releases/tag/v0.4.1). The other major addition is this documentation site!
...
This site, which is automatically generated from the [docs directory](https://github.com/integration-system/dep/tree/master/docs) within the dep repository by [docusaurus](http://docusaurus.io/), is now that comprehensive source of docs. More so than any individual bit of information, it provides some broader benefits:
...
For the former, we have a fair bit of work underway that, now that this release is out the door, we can move on quickly. That includes major performance improvements, solver improvements to pick a sane version more of the time with less manual intervention, allowing the `source` field to work the way [most people expect it to](https://github.com/integration-system/dep/issues/860), and others. The goal is also to move dep towards a more regular release schedule.
